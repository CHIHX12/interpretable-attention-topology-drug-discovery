...
def create_sharing_matrix(df, base_dir):
    ...
    plt.tight_layout()
    plt.savefig(base_dir / 'target_constitutive_sharing_matrix_active.png', dpi=300, bbox_inches='tight')
...
def create_overlap_network(sharing_df, base_dir):
    ...
    plt.tight_layout()
    plt.savefig(base_dir / 'network_overlap_diagram_active.png', dpi=300, bbox_inches='tight')
...
def create_functional_regions_plot(core_region, s125_region, low_imp_region, base_dir):
    ...
    plt.tight_layout()
    plt.savefig(base_dir / 'functional_regions_3d_active.png', dpi=300, bbox_inches='tight')
