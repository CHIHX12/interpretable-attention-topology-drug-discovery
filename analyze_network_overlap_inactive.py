...
def create_sharing_matrix(df, base_dir):
    ...
    ax.set_ylabel('Inactive Target Residue', fontsize=16, weight='bold')

    plt.xticks(rotation=90, fontsize=18, weight='bold')
    plt.yticks(fontsize=18, weight='bold')
    plt.tight_layout()
    plt.savefig(base_dir / 'target_constitutive_sharing_matrix_inactive.png', dpi=600, bbox_inches='tight')
...
def create_overlap_network(sharing_df, base_dir):
    ...
    plt.tight_layout()
    plt.savefig(base_dir / 'network_overlap_diagram_inactive.png', dpi=600, bbox_inches='tight')
...
def create_functional_regions_plot(region_info, base_dir):
    ...
    plt.tight_layout()
    plt.savefig(base_dir / 'functional_regions_3d_inactive.png', dpi=600, bbox_inches='tight')
